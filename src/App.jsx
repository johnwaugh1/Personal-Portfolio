...
const App = () => (
  <main className="relative flex flex-col space-y-5 h-full w-full bg-[radial-gradient(ellipse_300%_300%_at_50%_0%,#0d0208_0%,#008f11_100%)] overflow-hidden">
    {/* Grid Overlay */}
    <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,255,65,0.075)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,255,65,0.075)_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none"></div>
